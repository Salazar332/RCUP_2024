...
Motor::Motor(int right_pin, int left_pin, int speed_pin){
	r_pin = right_pin;
	l_pin = left_pin;
	s_pin = speed_pin;
	// speed = spd;
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------
LED::LED(uint8_t p_a,uint8_t p_b,uint8_t p_c){
	port_a = p_a;
...
void LED::blink(uint8_t red, uint8_t green, uint8_t blue){
	analogWrite(port_a, green);
	analogWrite(port_b, blue);
	analogWrite(port_c, red);
}
void LED::blink(uint8_t light){
	analogWrite(port_a, light);
}